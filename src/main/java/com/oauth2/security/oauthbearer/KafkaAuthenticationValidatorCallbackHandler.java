...
public class KafkaAuthenticationValidatorCallbackHandler implements AuthenticateCallbackHandler {
    private final Logger log = LoggerFactory.getLogger(KafkaAuthenticationValidatorCallbackHandler.class);
    ...
    private void handleCallback(OAuthBearerValidatorCallback callback){
        ...
        KafkaOAuthBearerTokenJwt token = KafkaOAuthHttpCalls.introspectBearer(this.moduleOptions, accessToken);
