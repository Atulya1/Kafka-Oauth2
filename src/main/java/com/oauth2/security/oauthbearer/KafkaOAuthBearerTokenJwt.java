...
public class KafkaOAuthBearerTokenJwt implements OAuthBearerToken {
    ...
    public KafkaOAuthBearerTokenJwt(String accessToken, long lifeTimeS, long startTimeMs, String principalName){
        super();
    ...
    public KafkaOAuthBearerTokenJwt(Map<String, Object> jwtToken, String accessToken){
        super();
        this.value = accessToken;
