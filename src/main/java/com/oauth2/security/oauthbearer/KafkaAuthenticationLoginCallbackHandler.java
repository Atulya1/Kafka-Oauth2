...
public class KafkaAuthenticationLoginCallbackHandler implements AuthenticateCallbackHandler {
    private final Logger log = LoggerFactory.getLogger(KafkaAuthenticationLoginCallbackHandler.class);
    ...
    private void handleCallback(OAuthBearerTokenCallback callback){
        ...
        KafkaOAuthBearerTokenJwt token = KafkaOAuthHttpCalls.login(this.moduleOptions);
